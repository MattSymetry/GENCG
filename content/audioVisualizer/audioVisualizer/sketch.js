let canvasSize, audioIn, fft, lows, mids, highs, triangle, centroid, radius, angleOffset, rotationDir, shapeIndex;
const minSize = 10;
const maxSize = 300;
function setup() {
    ...
    // Create object that keeps track of all needed object
    triangle = {
...
function draw() {
    ...
    // Calc brightness accordingly
    triangle.lows.color.y = 100-lows/3
    triangle.mids.color.y = 100-mids/3
    triangle.highs.color.y = 100-highs/3

    centroid = fft.getCentroid();
    angleOffset = centroid/100000
    radius = (lows + mids + highs) / 3

    // Move
    triangle.currPos.x += triangle.dir.x*centroid/1000
    triangle.currPos.y += triangle.dir.y*centroid/1000
